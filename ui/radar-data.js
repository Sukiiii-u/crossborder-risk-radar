window.RADAR_UI_DATA = {
  "meta": {
    "run_id": "radar-20260406-023613-0f03770c",
    "generated_at": "2026-04-06T02:36:13Z",
    "source_mode": "seed",
  ...
  "overview": {
    "headline": "通用雷达先盯 environment：欧盟发布更严格的包装与可回收要求，部分卖家可能需要调整材料与标签。",
    "why_it_matters": "这条 environment 事件已经不是某个单一画像的小波动，而是所有卖家都该先扫一眼的首页信号；先看事件本身，再按高相关 / 中相关 / 低相关分层动作。",
    "source_mode": "seed",
    "top_risk": {
      "event_title": "欧盟发布更严格的包装与可回收要求，部分卖家可能需要调整材料与标签。",
      "event_type": "environment",
      "risk_level": "medium",
      "seller_angle": "【雷达研判】该事件将从 强合规门槛导致商品无预警下架, 硬性运营与履约成本攀升, 全链路清关与尾程交付受阻 维度冲击 general 业务。关键细节提示：潜在 欧洲 环保 事件，可能会影响当前的跨境履约、利润或合规操作。这将直接导致 mixed 链路的稳定性受挫，建议立即启动 SOP 响应。"
    },
  ...
  "dashboard": {
    ...
    "top_story": {
      "title": "欧盟发布更严格的包装与可回收要求，部分卖家可能需要调整材料与标签。",
    ...
    "cards": [
      ...
      {
        "rank": 2,
        "title": "欧盟拟取消低价值包裹免税政策，并可能对跨境电商小包裹征收额外税费",
        "risk_type": "tariff",
        "priority": "low",
      ...
      {
        "rank": 3,
        "title": "某港口工会可能在下月发起罢工投票，跨境物流时效存在不确定性。",
        "risk_type": "logistics",
        "priority": "medium",
        "who_to_watch": "跨境直发（平台修正：全平台扫描 / 市场修正：EU / 时效、签收、退款链路最敏感）",
        "action": "今天先盘点承诺时效最紧的订单和 SKU，别让延误先炸差评"
      }
    ]
  },
  "today_actions": [
  ...
  "fulfillment_actions": [
    {
      ...
      "actions": [
        ...
        "紧盯 欧盟发布更严格的包装与可回收要求，部分卖家可能需要调整材料与标签。 的正式细则和执行时间，避免广告继续把亏损放大。"
      ],
      "watchouts": [
        "密切关注 欧盟发布更严格的包装与可回收要求，部分卖家可能需要调整材料与标签。 的最终执行日期和适用品类。"
      ],
    ...
    },
    {
      ...
      "actions": [
        ...
        "把 environment 风险翻译成平台内动作：提价、控量、调补货，不要只看新闻标题。"
      ],
      "watchouts": [
        "留意平台是否因 欧盟发布更严格的包装与可回收要求，部分卖家可能需要调整材料与标签。 调整仓配规则或绩效门槛。"
      ],
      "modifier": "平台修正：general / 市场修正：EU"
    },
    {
      ...
      "actions": [
        ...
        "针对 欧盟发布更严格的包装与可回收要求，部分卖家可能需要调整材料与标签。 预留备用清关行联系方式，评估核心 SKU 是否需前置拨备。"
      ],
      "watchouts": [
        "自发货路径优先关注 欧盟发布更严格的包装与可回收要求，部分卖家可能需要调整材料与标签。 对清关和尾程时效的影响。"
      ],
      "modifier": "平台修正：general / 市场修正：EU"
    }
  ],
  "events": [
    ...
    {
      "id": "欧盟发布更严格的包装与可回收要求，部分卖家可能需要调整材料与标签。",
      "category": "daily",
      "scope": "platform",
      "display_order": 1,
      "title": "欧盟发布更严格的包装与可回收要求，部分卖家可能需要调整材料与标签。",
      "raw_title": "欧盟发布更严格的包装与可回收要求，部分卖家可能需要调整材料与标签。",
      ...
      "source_type": "",
      "source_priority": "",
      "impact": "【雷达研判】该事件将从 强合规门槛导致商品无预警下架, 硬性运营与履约成本攀升, 全链路清关与尾程交付受阻 维度冲击 general 业务。关键细节提示：潜在 欧洲 环保 事件，可能会影响当前的跨境履约、利润或合规操作。这将直接导致 mixed 链路的稳定性受挫，建议立即启动 SOP 响应。",
    ...
    {
      "id": "欧盟拟取消低价值包裹免税政策，并可能对跨境电商小包裹征收额外税费",
      "category": "daily",
      "scope": "platform",
      "display_order": 2,
      "title": "欧盟拟取消低价值包裹免税政策，并可能对跨境电商小包裹征收额外税费",
      "raw_title": "欧盟拟取消低价值包裹免税政策，并可能对跨境电商小包裹征收额外税费",
    ...
    {
      "id": "某港口工会可能在下月发起罢工投票，跨境物流时效存在不确定性。",
      "category": "daily",
      "scope": "platform",
      "display_order": 3,
      "title": "某港口工会可能在下月发起罢工投票，跨境物流时效存在不确定性。",
      "raw_title": "某港口工会可能在下月发起罢工投票，跨境物流时效存在不确定性。",
      ...
      "source_type": "",
      "source_priority": "",
      "impact": "【雷达研判】该事件将从 全链路清关与尾程交付受阻, 在库积压或库容流转断裂 维度冲击 general 业务。关键细节提示：潜在 欧洲 物流 事件，可能会影响当前的跨境履约、利润或合规操作。这将直接导致 mixed 链路的稳定性受挫，建议立即启动 SOP 响应。",
      "subject": "布局 EU 市场的 general mixed 卖家",
      "action": "今天先盘点承诺时效最紧的订单和 SKU，别让延误先炸差评",
      "source": {
        "name": "user-provided",
