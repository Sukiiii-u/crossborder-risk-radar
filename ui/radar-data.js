window.RADAR_UI_DATA = {
  "meta": {
    "run_id": "radar-20260323-094208-ad28347c",
    "generated_at": "2026-03-23T09:42:08Z",
    "source_mode": "seed",
  ...
  "overview": {
    "headline": "通用雷达先盯 environment：欧盟包装新规将生效，不合规材料标签面临清关扣货风险",
    "why_it_matters": "这条 environment 事件已经不是某个单一画像的小波动，而是所有卖家都该先扫一眼的首页信号；先看事件本身，再按高相关 / 中相关 / 低相关分层动作。",
    "source_mode": "seed",
    "top_risk": {
      "event_title": "欧盟包装新规将生效，不合规材料标签面临清关扣货风险",
      "event_type": "environment",
      "risk_level": "medium",
      "seller_angle": "卖家面临包装材料成本上涨15%-30%，现有库存若使用不合规材料需紧急返工或报废处理。欧盟海关清关时将强化包装材料溯源审查，使用非认证材料的产品可能在边境被扣押，导致资金占用周期大幅延长。"
    },
  ...
  "dashboard": {
    ...
    "top_story": {
      "title": "欧盟包装新规将生效，不合规材料标签面临清关扣货风险",
    ...
    "cards": [
      {
        ...
        "action": "立即审计在欧在途及在库产品的包装材料成分与可回收标识"
      },
      {
        "rank": 2,
        "title": "欧盟取消小额免税政策，直邮卖家成本或暴涨",
        "risk_type": "tariff",
        "priority": "low",
        "who_to_watch": "跨境直发（平台修正：全平台扫描 / 市场修正：EU / 税后到手价与毛利最敏感）",
        "action": "核算含税后的各站点FOC价格竞争力"
      },
      {
        "rank": 3,
  ...
  "today_actions": [
    "立即审计在欧在途及在库产品的包装材料成分与可回收标识",
    "核算含税后的各站点FOC价格竞争力",
    "今天先盘点承诺时效最紧的订单和 SKU，别让延误先炸差评"
  ],
  "watch_items": [
    "联系合规包装供应商获取EU认证材料样品与报价",
    "启动高税负SKU筛选与淘汰机制",
  ...
  "fulfillment_actions": [
    {
      ...
      "actions": [
        "停用未获EU可回收认证的塑料袋与发泡材料，改用纸质缓冲包装",
        "在包裹面单及内部附上符合EN 13432标准的可降解声明"
      ],
      "watchouts": [
        "直发小包清关时海关可能抽检包装材料，务必确保面单标注与实际包装一致"
      ],
    ...
    },
    {
      ...
      "actions": [
        "向FBA或全托管仓提交包装材料合规证明文件，预审通过后再批量发货",
        "分批次小量试发新品包装至仓库，验证是否存在入库合规拦截"
      ],
      "watchouts": [
        "平台仓储端对包装尺寸和材料有硬性限制，不合格品将被拒绝入库且产生退运费用"
      ],
      "modifier": "平台修正：general / 市场修正：EU"
    },
    {
      ...
      "actions": [
        "与海外仓3PL服务商签署包装合规责任协议，明确材料更换时间节点",
        "对现有海外仓库存进行包装材料抽检，不合格品优先本地销毁或回收处理"
      ],
      "watchouts": [
        "自发货与海外仓路径的包装变更需同步更新HS编码申报信息，避免材料认证与海关归类产生矛盾"
      ],
      "modifier": "平台修正：general / 市场修正：EU"
    }
  ],
  "events": [
    ...
    {
      "id": "欧盟包装新规将生效，不合规材料标签面临清关扣货风险",
      "category": "daily",
      "scope": "platform",
      "display_order": 1,
      "title": "欧盟包装新规将生效，不合规材料标签面临清关扣货风险",
      "raw_title": "欧盟包装新规将生效，不合规材料标签面临清关扣货风险",
      ...
      "source_type": "",
      "source_priority": "",
      "impact": "卖家面临包装材料成本上涨15%-30%，现有库存若使用不合规材料需紧急返工或报废处理。欧盟海关清关时将强化包装材料溯源审查，使用非认证材料的产品可能在边境被扣押，导致资金占用周期大幅延长。",
    ...
    {
      "id": "欧盟取消小额免税政策，直邮卖家成本或暴涨",
      "category": "daily",
      "scope": "platform",
      "display_order": 2,
      "title": "欧盟取消小额免税政策，直邮卖家成本或暴涨",
      "raw_title": "欧盟取消小额免税政策，直邮卖家成本或暴涨",
      ...
      "source_type": "",
      "source_priority": "",
      "impact": "欧盟取消低价值包裹免税将直接压缩直邮卖家利润空间，低客单价商品可能陷入亏损。对于依赖价格竞争力的卖家，履约成本占比将从10-15%跳升至30%以上，库存备货策略也面临调整压力。",
      "subject": "布局 EU 市场的 general mixed 卖家",
      "action": "核算含税后的各站点FOC价格竞争力",
      "source": {
        "name": "user-provided",
